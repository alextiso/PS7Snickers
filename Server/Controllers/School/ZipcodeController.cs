...
namespace SNICKERS.Server.Controllers.School
{
    ...
    public class ZipcodeController : Controller
    {
        ...
        public async Task<IActionResult> GetZipcodes()
        {
            try
            {
                List<ZipcodeDTO> lstZipcode = await _context.Zipcodes.OrderBy(x => x.Zip)
        ...
        public async Task<IActionResult> GetZipcodes(int pZip)
        {
            try
            {

                ZipcodeDTO itmZip = await _context.Zipcodes
                    .Where(x => x.Zip == pZip.ToString())
                    .OrderBy(x => x.Zip)
                   .Select(sp => new ZipcodeDTO
                   {
                       Zip = sp.Zip,
        ...
        public async Task<IActionResult> DeleteZipcode(int pZip)
        {
