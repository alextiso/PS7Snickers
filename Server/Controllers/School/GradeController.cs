...
namespace SNICKERS.Server.Controllers.School
{
    ...
    public class GradeController : Controller
    {
        ...
        public async Task<IActionResult> GetGrades()
        {
            try
            {
                List<GradeDTO> lstGrades = await _context.Grades.OrderBy(x => x.SchoolId)
        ...
        [HttpGet]
        [Route("GetGrades/{pSchoolId}")]
        public async Task<IActionResult> GetGrades(int pSchoolId)
        {
            try
            {

                GradeDTO itmGrade = await _context.Grades
        ...
        public async Task<IActionResult> PutGrade(GradeDTO _GradeDTO)
        {
            ...
            {
                var trans = await _context.Database.BeginTransactionAsync();
                Grade c = await _context.Grades.Where(x => x.SchoolId.Equals(_GradeDTO.SchoolId)).FirstOrDefaultAsync();
        ...
        [HttpDelete]
        [Route("DeleteGrades/{pSchoolId}")]
        public async Task<IActionResult> DeleteGrade(int pSchoolId)
        {
            ...
            try
            {
                ...
                var trans = await _context.Database.BeginTransactionAsync();
                Grade c = await _context.Grades.Where(x => x.SchoolId.Equals(pSchoolId)).FirstOrDefaultAsync();
        ...
        [HttpPost]
        [Route("GetGrades")]
        public async Task<DataEnvelope<GradeDTO>> GetGradesPost([FromBody] DataSourceRequest gridRequest)
        {
