...
namespace SNICKERS.Server.Controllers.School
{
    ...
    public class GradeTypeWeightController : Controller
    {
        ...
        [HttpDelete]
        [Route("DeleteGradeTypeWeights/{pSchoolId}")]
        ...
        [HttpPost]
        [Route("GetGradeTypeWeights")]
        public async Task<DataEnvelope<GradeTypeWeightDTO>> GetGradeConversionsPost([FromBody] DataSourceRequest gridRequest)
        {
