...
namespace SNICKERS.Server.Controllers.School
{
    ...
    public class InstructorController : Controller
    {
        ...
        public async Task<IActionResult> GetInstructors()
        {
            try
            {
                List<InstructorDTO> lstInstructors = await _context.Instructors.OrderBy(x => x.SchoolId)
        ...
        [HttpGet]
        [Route("GetInstructors/{pSchoolId}")]
        public async Task<IActionResult> GetInstructors(int pSchoolId)
        {
            try
            {
        ...
        public async Task<IActionResult> PutInstructor(InstructorDTO _InstructorDTO)
        {
            ...
            {
                var trans = await _context.Database.BeginTransactionAsync();
                Instructor c = await _context.Instructors.Where(x => x.SchoolId.Equals(_InstructorDTO.SchoolId)).FirstOrDefaultAsync();
        ...
        [HttpDelete]
        [Route("DeleteInstructor/{pSchoolId}")]
        public async Task<IActionResult> DeleteInstructor(int pSchoolId)
        {
            ...
            try
            {
                ...
                var trans = await _context.Database.BeginTransactionAsync();
                Instructor c = await _context.Instructors.Where(x => x.SchoolId.Equals(pSchoolId)).FirstOrDefaultAsync();
