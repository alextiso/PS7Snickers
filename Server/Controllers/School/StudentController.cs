...
namespace SNICKERS.Server.Controllers.School
{
    ...
    public class StudentController : Controller
    {
        ...
        public async Task<IActionResult> GetStudents()
        {
            try
            {
                List<StudentDTO> lstStudents = await _context.Students.OrderBy(x => x.SchoolId)
        ...
        [HttpGet]
        [Route("GetStudents/{pSchoolId}")]
        public async Task<IActionResult> GetStudents(int pSchoolId)
        {
            try
            {
        ...
        public async Task<IActionResult> PutStudent(StudentDTO _StudentDTO)
        {
            ...
            {
                var trans = await _context.Database.BeginTransactionAsync();
                Student c = await _context.Students.Where(x => x.SchoolId.Equals(_StudentDTO.SchoolId)).FirstOrDefaultAsync();
        ...
        [HttpDelete]
        [Route("DeleteStudent/{pSchoolId}")]
        public async Task<IActionResult> DeleteStudent(int pSchoolId)
        {
            ...
            try
            {
                ...
                var trans = await _context.Database.BeginTransactionAsync();
                Student c = await _context.Students.Where(x => x.SchoolId.Equals(pSchoolId)).FirstOrDefaultAsync();
